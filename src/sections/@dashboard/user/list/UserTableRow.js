...
export default function UserTableRow({ row, selected, onEditRow, onSelectRow, onDeleteRow }) {
  ...
  const { projectName, referenceNo, revNo, rep, createdBy, revisiedBy, dataCreated,  dataRevised, status} = row;
  ...
  return (
    <TableRow hover sx={{ borderBottom: '1px solid #a7b1bc' }} selected={selected}>
      ...
      <TableCell align="center">{dataCreated}</TableCell>
      <TableCell align="center">{dataRevised}</TableCell>
      <TableCell align="left">
        <Label
